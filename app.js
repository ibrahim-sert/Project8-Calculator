...
buttonsContainer.addEventListener("click", (e) => {
  ...
  if (
    ...
    currentDisplayField.innerText.length < 8
  ) {
    if (
      (currentDisplayField.innerText == "" &&
        e.target.classList.contains("number-0")) ||
        ...
        if (currentDisplayField.innerText !== "") {
          if (previousDisplayField.innerText.includes("+")) {
            ...
            const previousNumber = Number(
              previousDisplayField.innerText.split(" ")[0]
            );
    ...
    switch (func) {
      ...
      case "±":
        if (!currentDisplayField.innerText.includes("-")) {
          ...
          currentDisplayField.innerText =
            currentDisplayField.innerText.split("-")[1];
        }
        break;
      case "%":
        // if (currentDisplayField.innerText !== '') {
        ...
        // }
        currentDisplayField.innerText =
          Number(currentDisplayField.innerText) / 100;
      default:
        break;
    }
  }
